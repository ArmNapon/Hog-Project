...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    while who == 0:
        num_rolls_player = strategy0(score0, score1)
        x = take_turn(num_rolls_player, score1, dice)
        score0 = score0 + x
        extra0 = extra_turn(score0, score1)
        while extra0 == True:
            num_rolls_player = strategy0(score0, score1)
            x = take_turn(num_rolls_player, score1, dice)
            score0 = score0 + x
        ...
        if score0 >= goal:
            return score0, score1
        num_rolls_player = strategy1(score1, score0)
        y = take_turn(num_rolls_player, score0, dice)
        score1 = score1 + y
        extra1 = extra_turn(score1, score0)
        while extra1 == True:
            num_rolls_player = strategy1(score1, score0)
            y = take_turn(num_rolls_player, score0, dice)
            score1 = score1 + y
